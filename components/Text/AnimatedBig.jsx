...
const AnimatedBig = ({
  ...
  useEffect(() => {
    ...
    const split = new SplitText(copyRef.current, {
      type: "chars", // Change this to split into characters
    });
    ...
    chars.forEach((char) => {
      ...
      char.innerHTML = `<span class=\"char-inner-${copyId}\">${content}</span>`;
    });
